    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פארק טק - Park-Tech משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'df7aadb6-0bda-4d3a-8801-c6c4b6a87c16',
                    name: data.name || '',
                    email: data.email || '',
